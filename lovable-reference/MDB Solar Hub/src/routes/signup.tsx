...
export const Route = createFileRoute("/signup")({
  head: () => ({ meta: [{ title: "Create account — MDB Solar OS" }] }),
...
function SignupPage() {
  ...
  const [fullName, setFullName] = useState("Diego Mota");
      ...
      <div className="hidden lg:flex relative flex-col justify-between p-12 text-primary-foreground overflow-hidden"
        ...
        <div className="relative space-y-6">
          <h1 className="text-5xl font-bold leading-tight tracking-tight">
            Join the <span className="text-gold">MDB team</span>.
          </h1>
          <p className="text-lg opacity-80 max-w-md">
            One account for pipeline, proposals, projects, and your AI copilot. Built for Florida solar, water, roofing, HVAC, battery, and EV.
          </p>
          <div className="grid grid-cols-3 gap-3 max-w-md pt-4">
            {[{ icon: Zap, label: "Solar" }, { icon: Droplets, label: "Water" }, { icon: ShieldCheck, label: "Home" }].map((p) => (
      ...
      <div className="flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            <div className="text-xs font-semibold text-primary uppercase tracking-widest">Create account</div>
            <h2 className="text-3xl font-bold tracking-tight">Set up your MDB workspace.</h2>
            <p className="text-muted-foreground text-sm">It takes 30 seconds. We'll provision your pipeline immediately.</p>
          </div>
