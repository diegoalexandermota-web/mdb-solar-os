// lib/ai/generateSolarProposalSummary.ts
// Mock AI summary generator for MDB Solar OS
...
export function generateSolarProposalSummary(input: SolarProposalSummaryInput): SolarProposalSummaryOutput {
  ...
  return {
    ...
    next_step: `Schedule a call to review your proposal and answer any questions.`
  };
}
